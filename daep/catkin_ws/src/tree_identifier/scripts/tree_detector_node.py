...
class TreeDetectorNode(object):
    ...
    def __init__(self):
        ...
        self.max_points = rospy.get_param("~max_points", 180000)
        self.marker_lifetime = rospy.get_param("~marker_lifetime", 0.8)

        self.ransac_iterations = rospy.get_param("~ransac_iterations", 50)
        self.ransac_distance_threshold = rospy.get_param("~ransac_distance_threshold", 0.01)
        self.ransac_min_inlier_ratio = rospy.get_param("~ransac_min_inlier_ratio", 0.0)
        self.min_diameter = rospy.get_param("~min_diameter", 0.15)
        ...
        self.gmm_radius_threshold = rospy.get_param("~gmm_radius_threshold", 0.25)
        self.gmm_min_points = rospy.get_param("~gmm_min_points", 10)
        self.gmm_components = rospy.get_param("~gmm_components", 2)
        self.gmm_min_center_dist = rospy.get_param("~gmm_min_center_dist", 0.0)
